...
const CustomButton = ({
  ...
  return (
    <button
      ...
      } uppercase bg-white px-${paddingX} py-${paddingY} text-${textSize} border  border-gray-300 font-bold text-blue-600 shadow-sm  hover:bg-gray-100 focus:outline-none focus:ring-2`}
    >
      {text}
    </button>
  );
