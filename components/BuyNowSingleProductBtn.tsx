...
const BuyNowSingleProductBtn = ({
  ...
  return (
    <button
      ...
      className="daisy-btn w-[200px] text-lg  border-blue-500 hover:border-blue-500 border font-normal bg-blue-500 text-white hover:bg-white hover:scale-110 hover:text-blue-500 transition-all uppercase ease-in max-[500px]:w-full"
    >
      Buy Now
    </button>
  );
